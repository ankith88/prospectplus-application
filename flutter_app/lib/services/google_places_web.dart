...
class GooglePlacesWebHelper {
  ...
  static void _ensureInitialized() {
    ...
    final script = html.ScriptElement()
      ..text = """
        window.googlePlacesSearch = function(query) {
          console.log('JS: googlePlacesSearch called for:', query);
          return new Promise((resolve) => {
            try {
              if (typeof google === 'undefined' || !google.maps || !google.maps.places) {
                console.error('JS: google.maps.places not available');
                resolve([]); return;
              }
              ...
              console.error('JS: Error in search', e);
              resolve([]); 
            }
          });
        };
    ...
    _initialized = true;
    debugPrint('GooglePlacesWebHelper: JS functions injected successfully.');
  }
  ...
  static Future<List<Map<String, dynamic>>> searchPlaces(String query) async {
    try {
      ...
      return (js_util.dartify(result) as List).cast<Map<String, dynamic>>();
    } catch (e) {
