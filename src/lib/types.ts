...
export type UserRole = 'user' | 'Outbound Admin' | 'admin' | 'Field Sales' | 'Field Sales Admin' | 'Lead Gen' | 'Lead Gen Admin' | 'Franchisee' | 'Sales Manager' | 'Dashback' | 'Account Managers' | 'Account Manager' | 'account managers' | 'dialers' | 'Dialer' | 'Marketing Admin' | 'Marketing Manager' | 'Customer Success' | 'Customer Service' | 'super user' | 'Operations' | 'Finance' | 'Finanace Manager' | 'Finance Manager' | 'Data Admin';
