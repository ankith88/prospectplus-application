                                        ...
                                        <div className="space-y-6 pt-4">
                                            ...
                                            <Card>
                                                ...
                                                <CardContent className="space-y-4">
                                                    ...
                                                    <FormField control={discoveryForm.control} name="personSpokenWithTitle" render={({ field }) => (<FormItem><FormLabel>Job Title</FormLabel><FormControl><Input placeholder="Manager" {...field} /></FormControl><FormMessage /></FormItem>)} />
                                            ...
                                            <Card>
                                                ...
                                                <CardContent className="space-y-4">
                                                    ...
                                                    <FormField control={discoveryForm.control} name="decisionMakerTitle" render={({ field }) => (<FormItem><FormLabel>Job Title</FormLabel><FormControl><Input placeholder="Owner" {...field} /></FormControl><FormMessage /></FormItem>)} />
