...
export default function VisitNotesPage() {
  ...
  const hasAccess = userProfile?.activeRole && userProfile.activeRole.toLowerCase() !== 'franchisee' && ['admin', 'Marketing Manager', 'Lead Gen', 'Lead Gen Admin', 'Field Sales', 'Field Sales Admin', 'Dashback', 'Sales Manager'].includes(userProfile.activeRole);
  if (loading) {
    return (
