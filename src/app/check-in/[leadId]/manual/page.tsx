...
import { z } from 'zod';
import { getLeadFromFirebase, updateLeadCheckinQuestions, addContactToLead, updateContactInLead, logActivity, getCompaniesFromFirebase, bulkMoveLeadsToBucket, updateLeadStatus, getAllUsers } from '@/services/firebase';
import type { Lead, CheckinQuestion, Contact, LeadStatus, Address, UserProfile } from '@/lib/types';
...
export default function ManualCheckinPage() {
    ...
    const renderStep = () => {
        const onNextAction = currentStep === TOTAL_STEPS ? () => router.push('/field-sales') : handleSaveAndNext;
