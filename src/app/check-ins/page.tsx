...
export default function CheckInsPage() {
  ...
  const hasAccess = userProfile?.activeRole && ['admin', 'Marketing Manager', 'Field Sales', 'Field Sales Admin', 'Lead Gen Admin', 'Dashback', 'Sales Manager'].includes(userProfile.activeRole);
  if (loading) {
    return (
