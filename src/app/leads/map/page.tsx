...
export default function TerritoryMapPage() {
  ...
  const hasAccess = userProfile?.activeRole && ['admin', 'Marketing Admin', 'Marketing Manager', 'Field Sales', 'Field Sales Admin', 'Franchisee', 'Lead Gen', 'Lead Gen Admin', 'user', 'Account Manager', 'Account Managers', 'account managers', 'Customer Service', 'Customer Success', 'customer_success'].includes(userProfile.activeRole);
  if (loading) {
    return (
