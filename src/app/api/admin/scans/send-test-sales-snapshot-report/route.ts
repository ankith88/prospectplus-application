...
export async function POST(request: Request) {
  try {
    ...
    function isManualActivity(act: any): boolean {
      if (!act) return false;
      if (
      ...
      if (['system', 'automation', 'campaign', 'nurture', 'api', 'webhook', 'netsuite', 'bot', 'cron', 'data_management', 'data-management', 'csv_upload', 'csv', 'bulk_import'].includes(source)) {
        return false;
      }
      const author = (act.author || '').toString().trim().toLowerCase();
      if (!author || author === 'unknown rep' || author === 'unassigned' || author.includes('system') || author.includes('engine') || author.includes('webhook') || author.includes('api') || author.includes('assistant') || author.includes('operator') || author.includes('nudge') || author.includes('cron') || author.includes('automation') || author.includes('bot') || author.includes('prospectplus') || author.includes('netsuite') || author.includes('opt-out') || author.includes('portal') || author.includes('booking') || author.includes('registration') || author.includes('external') || author.includes('data management') || author.includes('csv upload') || author.includes('bulk import')) {
        return false;
      }
      const noteText = (act.notes || act.content || act.event || act.title || '').toString().toLowerCase();
      if (
        noteText.includes('csv') || noteText.includes('bulk import') || noteText.includes('import wizard') || noteText.includes('lead imported') || noteText.includes('imported via') || noteText.includes('imported as') || noteText.includes('imported from') ||
        noteText.includes('data management') || noteText.includes('data-management') || noteText.includes('status changed') || noteText.includes('status updated') || noteText.includes('bucket updated') || noteText.includes('bucket changed') || noteText.includes('stage changed') || noteText.includes('lead moved to') || noteText.includes('reassigned to') || noteText.includes('auto-assigned') || noteText.includes('system note:') || noteText.includes('system:') ||
        noteText.includes('campaign email') || noteText.includes('sent campaign email') || noteText.includes('campaign:') || noteText.includes('nurture:') || noteText.includes('nurture sequence') || noteText.includes('nurture step') || noteText.includes('automated email') || noteText.includes('automated sms') || noteText.includes('drip email') || noteText.includes('enrolled in nurture') || noteText.includes('opt-out') || noteText.includes('unsubscribed') ||
        noteText.includes('netsuite sync') || noteText.includes('transcript added') || noteText.includes('synced from') || noteText.includes('batch updated') || noteText.includes('scanned by') || noteText.includes('triggered') || noteText.includes('rule executed') || noteText.includes('localmile nudge') || noteText.includes('localmile.plus webhook') || noteText.includes('performed by: system') || noteText.includes('system backfill script') || noteText.includes('avatar updated') || noteText.includes('lead merged')
      ) {
        return false;
      }
      return true;
