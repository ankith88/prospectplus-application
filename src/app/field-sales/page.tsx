...
export default function DoorToDoorDashboard() {
  ...
  const hasAccess = userProfile?.activeRole && userProfile.activeRole.toLowerCase() !== 'franchisee' && ['admin', 'Marketing Manager', 'Field Sales', 'Field Sales Admin', 'Dashback'].includes(userProfile.activeRole);
