...
import { NurtureJourneys } from '@/components/marketing/nurture-journeys';

export default function NurtureJourneysPage() {
    ...
    <div className="flex flex-col gap-6 p-6 max-w-7xl mx-auto min-h-screen">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">
          Design automated triggers, wait durations, conditional rules, and auto-reassignment actions
        </p>
      </div>
