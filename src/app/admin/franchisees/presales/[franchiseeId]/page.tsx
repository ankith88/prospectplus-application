      ...
      <div className="w-full space-y-6">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            {/* STEP 4: PRESALES DETAILS */}
            {activeStep === 4 && (
              <div className="space-y-4">
                <div className="bg-[#095c7b] text-white py-2.5 px-6 text-xs font-bold tracking-widest uppercase rounded-lg shadow-sm flex items-center justify-between">
                  <span>PRESALES DETAILS</span>
                  <span className="text-[11px] font-normal text-slate-200">Step Status: {step4Status}</span>
                </div>

                <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col sm:flex-row sm:items-center bg-white border border-slate-300 rounded-lg shadow-sm overflow-hidden">
                      <span className="bg-slate-100 text-slate-700 text-xs font-bold uppercase px-3 py-2 sm:py-3 border-b sm:border-b-0 sm:border-r border-slate-300 whitespace-nowrap sm:min-w-[160px]">
                        SALE PRICE ($)
                      </span>
                      <Input
                        type="number"
