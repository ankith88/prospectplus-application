...
export async function convertParentLeadToSignedCustomer(parentLeadId: string, childLeadOrCompanyIds?: string[]) {
    try {
        ...
        const parentCompanyPayload: any = {
            ...
            leadType: parentData.leadType || 'Service',
            lpoLeadId: parentData.lpoLeadId || parentData.linkedLpoLeadId || undefined,
            lpoLeadName: parentData.lpoLeadName || parentData.lpoName || undefined,
            ampoRate: parentData.ampoRate,
            pmpoRate: parentData.pmpoRate,
            packageRate: parentData.packageRate,
            additionalBagRate: parentData.additionalBagRate,
            servicesAndRates: parentData.servicesAndRates,
            services: parentData.services || [],
